...
public class PersonDirector extends JFrame {
	...
	public void builderPerson() {
		/*
		 * personBuilder.builderHead(); personBuilder.builderBody();
		 * personBuilder.builderArmLeft(); personBuilder.builderArmRight();
		 * personBuilder.builderLegLeft(); personBuilder.builderLegRight();
		 */
	}
}
